...
<div class="py-4">
    ...
    <form action="http://localhost:8888/1pwr_II/index.php/asset/" method="post">
        <div class="d-flex justify-content-between w-100 flex-wrap">
            ...
            <div>
                <a href="<?php echo esc_url( get_permalink(get_page_by_path('edit-employee')) ) . '?edit=' . $employee->employee_id; ?>" class="btn btn-gray-800 d-inline-flex align-items-center me-2">
