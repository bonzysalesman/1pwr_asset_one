<?php
/*
Template Name: Custom Asset List
*/
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <a href="<?php echo get_permalink(get_page_by_path('add-asset')) . '?asset_id=' . $asset->asset_id; ?>" 
                                ...
                                <a href="<?php echo get_permalink(get_page_by_path('asset-history')) . '?asset_id=' . $asset->asset_id; ?>" 
