  ...
  <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
      ...
      <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
        <div class="d-flex align-items-center">
          <div class="avatar-lg me-4">
            <!--
            <img src="<?php bloginfo('template_url'); ?>/assets/img/team/profile-picture-3.jpg" class="card-img-top rounded-circle border-white" alt="Bonnie Green">
            -->
      ...
      <ul class="nav flex-column pt-3 pt-md-0">
        ...
        <li class="nav-item">
          <span class="nav-link collapsed d-flex justify-content-between align-items-center" 
                data-bs-toggle="collapse" data-bs-target="#submenu-assets">
              <span>
                  <span class="sidebar-icon">
          ...
          <div class="multi-level collapse" role="list" id="submenu-assets" aria-expanded="false">
              <ul class="flex-column nav">
                  <li class="nav-item">
                      <a class="nav-link" href="<?php echo get_permalink(get_page_by_path('assets')); ?>">
                          <span class="sidebar-text">View All</span>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="<?php echo get_permalink(get_page_by_path('add-asset')); ?>">
                          <span class="sidebar-text">Add New Asset</span>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="<?php echo get_permalink(get_page_by_path('categories')); ?>">
        ...
        <li class="nav-item">
    <span class="nav-link d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#submenu-employees" aria-expanded="false">
        <span>
            <span class="sidebar-icon">
                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="multi-level collapse" role="list" id="submenu-employees" aria-expanded="false">
        <ul class="flex-column nav">
            <!-- View All Employees -->
            <li class="nav-item">
                <a class="nav-link" href="http://localhost:8888/1pwr_II/index.php/employee-list/">
            ...
            <!-- Add New Employee -->
            <li class="nav-item">
                <a class="nav-link" href="http://localhost:8888/1pwr_II/index.php/add-employee/">
            ...
            <!-- Departments -->
            <li class="nav-item">
                <a class="nav-link" href="http://localhost:8888/1pwr_II/index.php/departments/">
...
<li class="nav-item">
    <span class="nav-link d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#submenu-requests" aria-expanded="true">
        <span>
            <span class="sidebar-icon">
                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="multi-level collapse show" role="list" id="submenu-requests" aria-expanded="false" style="">
        <ul class="flex-column nav">
            <!-- View All Requests -->
            <li class="nav-item">
                <a class="nav-link" href="<?php bloginfo('url'); ?>/index.php/requests-list/">
            ...
            <!-- Edit Request -->
            <li class="nav-item">
                <a class="nav-link" href="/Edit Request">
                    <span class="sidebar-text">Edit Request</span>
                </a>
            </li>
        </ul>
    </div>
        ...
        <li class="nav-item">
            <a href="<?php bloginfo('url'); ?>/index.php/account/" class="nav-link d-flex align-items-center">
                ...
                <span class="sidebar-text">Account <!-- <span class="badge badge-sm bg-secondary ms-1 text-gray-800">v1.4</span></span> -->
            </a>
        </li>
        <li class="nav-item">
