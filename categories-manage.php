<?php
/*
Template Name: Categories Manage
*/
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Verify nonce
    if (isset($_POST['_wpnonce']) && wp_verify_nonce($_POST['_wpnonce'], 'save_category')) {
        ...
        <tbody>
            <?php foreach ($categories as $cat) : ?>
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="<?php echo esc_url(add_query_arg('category_id', $cat->category_id)); ?>" 
